...
const TIMEOUT_MS = targets.includes("claude") || targets.includes("codex") || targets.includes("qwen") || targets.includes("opencode") || targets.includes("hermes")
  ? 360_000
  : 120_000;
...
function parseTargets(args) {
  ...
  if (mode === "--all") return ["direct", "kimi", "claude", "codex", "qwen", "opencode", "hermes"];
  throw new Error("Usage: smoke-browser-providers.mjs [--direct|--kimi|--claude|--codex|--qwen|--opencode|--hermes|--deterministic|--all]");
}
