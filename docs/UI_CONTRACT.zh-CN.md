...
- 底部 dock 包含 Terminal、Codex、Claude、Kimi、OpenCode、Hermes 和 Browser。Settings 是独立 tile。Browser 打开或聚焦唯一的内置浏览器卡片，绝不启动外部浏览器。Agent badge 不会覆盖 Browser launcher 图标。
